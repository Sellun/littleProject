	...
	class Silence {
		...
		buildBloggerProfile() {
			...
			var title = '<div class="site-branding">' +
					...
					'<a href="https://www.cnblogs.com/sellun/" alt="不怕热星人">' +
					'<ruby><span class="sakuraso">暑さにめげない</span><span class="no">の</span><span class="shironeko">人</span>' +
					'<rt class="chinese-font">不怕热星人</rt></ruby></a></span>' +
					'</div>'
			$('body').prepend(title);
